...
In this question, we want to see the consequences of changing parameter $a$. Observing figure~\ref{fig:prob3_d_multiple_a}, we understand that increasing the parameter's value increases the oscillation's frequency
